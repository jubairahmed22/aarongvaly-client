...
export function BrandsDirectoryClient({
  ...
  // Real measured navbar height - a hardcoded per-breakpoint guess drifted
  // out of sync with the actual rendered navbar and got clipped behind it.
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <nav
        ...
        className="sticky z-30 -mx-3 border-y border-neutral-200 bg-paper/95 px-3 py-2 backdrop-blur md:-mx-4 md:px-4 lg:mx-0 lg:px-0"
      >
