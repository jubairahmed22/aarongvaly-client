...
/**
 * HeroBanner - full-width hero. Dark background with an orange CTA,
 * bold uppercase headline, and a geometric SVG panel.
 */
        ...
        <div className="mt-2 flex flex-wrap items-center gap-3">
          {primaryCta ? (
            <Link
              ...
              className="inline-flex items-center gap-2 bg-accent px-6 py-3 text-sm font-bold uppercase tracking-widest text-ink transition-opacity hover:opacity-90"
            >
              {primaryCta.label}
        ...
        <svg className="absolute inset-0 h-full w-full" viewBox="0 0 400 400" fill="none">
          <defs>
            <pattern id="hero-grid" width="40" height="40" patternUnits="userSpaceOnUse">
              <path d="M 40 0 L 0 0 0 40" fill="none" stroke="var(--color-accent)" strokeWidth="0.3" opacity="0.3" />
            </pattern>
          </defs>
          <rect width="400" height="400" fill="url(#hero-grid)" />
          {/* Outer ring */}
          <circle cx="200" cy="200" r="160" stroke="var(--color-accent)" strokeWidth="0.5" fill="none" opacity="0.2" />
          {/* Middle ring */}
          <circle cx="200" cy="200" r="100" stroke="var(--color-accent)" strokeWidth="1" fill="none" opacity="0.4" />
          {/* Inner filled accent circle */}
          <circle cx="200" cy="200" r="40" fill="var(--color-accent)" opacity="0.15" />
          <circle cx="200" cy="200" r="4" fill="var(--color-accent)" />
          {/* Diagonal accent lines */}
          <line x1="60" y1="60" x2="340" y2="340" stroke="var(--color-accent)" strokeWidth="0.5" opacity="0.15" />
          <line x1="340" y1="60" x2="60" y2="340" stroke="var(--color-accent)" strokeWidth="0.5" opacity="0.15" />
        </svg>
      </div>
