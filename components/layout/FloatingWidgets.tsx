  ...
  return (
    <>
      ...
      >
        ...
        <span className="bg-accent px-2 py-1 text-center text-[10px] font-bold text-ink">
          ...
          {items.length > 0 ? (
            <footer className="border-t border-neutral-200 bg-paper px-3 py-2">
              ...
              <Link
                href="/checkout"
                onClick={() => setOpen(false)}
                className="flex h-[48px] w-full items-center justify-center gap-1 rounded-xl bg-accent text-sm font-bold uppercase tracking-wider text-ink transition-opacity hover:opacity-90"
              >
                Proceed
