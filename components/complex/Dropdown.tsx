...
/** Exposed for custom in-panel content (e.g. a nested/expandable menu) that
 * needs to close the dropdown itself - e.g. on navigating via a plain
 * `<Link>` that isn't wrapped in `DropdownItem`. */
